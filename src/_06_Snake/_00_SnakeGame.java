...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	private void gameOver() {
		...
		int answer = JOptionPane.showOptionDialog(null, "Do you want to play again?", "Game Over", 0, -1, null, choices, 0);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(snake.getHeadLocation().x == foodLocation.x) {
